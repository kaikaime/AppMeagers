    ...
    private void netWorkLoadingView() {
        basePager = new BasePager(this) {
            ...
            protected View initSuccessView() {
                ...
                if(info!=null){
                    recyclerView.setAdapter( FansRecyViewAdapter.newInstanceRecyViewApdater(info, FansItemActivity.this));
                }
                //设置刷新控件的背景颜色
            ...
            public ResultState getResultState() {
                ...
                if(HandlerUtils.checkNetWork()){
                    ...
                    if(Constant.errcode.equals(fansBean.errcode)&&fansBean.data.info !=null && fansBean.data.info.size()>0){
                        ...
                        if(FansRecyViewAdapter.getMyRecyViewAdapter() != null){
                            infoList = new ArrayList<>(FansRecyViewAdapter.getMyRecyViewAdapter().getList());
                        }
                        info.clear();
