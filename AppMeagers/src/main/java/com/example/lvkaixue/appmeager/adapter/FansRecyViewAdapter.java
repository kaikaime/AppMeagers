 ...
 */
public class FansRecyViewAdapter {
    private static MyRecyViewAdapter myRecyViewAdapter;
    public static MyRecyViewAdapter newInstanceRecyViewApdater(List<FansBean.Data.Info> list,Context context){
    ...
    public static MyRecyViewAdapter getMyRecyViewAdapter(){
        return myRecyViewAdapter;
    }



    public static class MyRecyViewAdapter extends RecyclerView.Adapter<MyRecyViewAdapter.MyViewHolder>  implements AboutPerProtocol.AboutPerLinstener{
        ...
        public MyRecyViewAdapter(List<FansBean.Data.Info> list, Context context){
            this.list = list;
                ...
                viewHodler.rlAbout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(viewHodler.textAbout.getVisibility()==View.GONE){
                            //关注
                           new AboutPerProtocol(MyRecyViewAdapter.this).requestNetWorkAbout(info.name, info.openid);
                        } else if(viewHodler.textNoAbout.getVisibility() == View.GONE){
                            new AboutPerProtocol(MyRecyViewAdapter.this).requestNetWorkCancel(info.name, info.openid);
                        }
                    }
                });
            }
        ...
        public void getNetWorkState(boolean flag) {
            ...
            System.out.println("当前的对象: "+list.get(index).nick+" "+list.get(index).isidol);
        }
    }
}