 ...
 */
public class RecyAdapterIndex {
    private static MyRecyViewAdapter myRecyViewAdapter;

    public static MyRecyViewAdapter newInstanceRecyViewApdater(List<IdolBean.Data.Info> list,Context context){
    ...
    private static class MyRecyViewAdapter extends RecyclerView.Adapter<MyViewHolder>{
        ...
        private MyRecyViewAdapter(List<IdolBean.Data.Info> list,Context context){
            this.list = list;
            this.context = context;
            inflater = LayoutInflater.from(context);
        }
        private void setNotifyData(List<IdolBean.Data.Info> list){
            this.list = list;
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View viewHolder = inflater.inflate(R.layout.list_item_persion,null, false);
